...
const ProductHorizontal = (): JSX.Element => {
      ...
      return (
                    ...
                    <View style={{flex:1}} >
                        <View style = {{flex:1,flexWrap:"wrap" , flexDirection:"row",justifyContent:"center",alignItems:"center"}}>
                         <View style={{flex:1,alignContent:"center",alignItems:"flex-start" ,padding:10}}>
                          <DefaultLabel  size={FONT_SIZE.large} title={"Best Seller"}/>
                         </View>
                  ...
                  <FlatList
                                          ...
                                          renderItem={({ item }) => item && <CartProduct styles={{ width: screenWidth / 2.5, height: screenHeight / 3.5 }} imageStyles={{ padding: screenHeight / 16 }} title="Green Chilly - 100gm - (Hari mirch)" imageUri={"https://freepngimg.com/thumb/strawberry/58-strawberry-png-images.png"} />
                                    }
                                    />
                  </View>
                  </View>
